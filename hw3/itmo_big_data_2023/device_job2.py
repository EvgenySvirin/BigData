...
def python_data_stream_example():
    ...
    #Добавил
    hadoop_storage = CheckpointStorage("hdfs://namenode:8020/tmp/checkpoints/logs")
    env.get_checkpoint_config().set_checkpoint_storage(hadoop_storage)
